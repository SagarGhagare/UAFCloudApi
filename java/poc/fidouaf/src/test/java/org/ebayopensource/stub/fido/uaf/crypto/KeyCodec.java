...
public class KeyCodec {
    ...
    public static byte[] getBCKeyAsRawBytes(String base64EncodedPubKey) throws GeneralSecurityException, IOException {
        return getBCKeyAsRawBytes((BCECPublicKey) getPubKey(java.util.Base64.getDecoder().decode(base64EncodedPubKey)));
    }
    ...
    public static byte[] getBCKeyAsRawBytes(org.bouncycastle.jce.interfaces.ECPublicKey pub) throws IOException {
        byte[] raw;
    ...
    public static byte[] getKeyAsXY(org.bouncycastle.jce.interfaces.ECPublicKey pub) throws IOException {
        byte[] raw;
