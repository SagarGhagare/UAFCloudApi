...
package org.ebayopensource.stub.fido.uaf.client;

import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;
import org.bouncycastle.jce.provider.BouncyCastleProvider;
//import org.ebayopensource.fidouafclient.util.Preferences;
import org.ebayopensource.stub.fido.uaf.crypto.BCrypt;
import org.ebayopensource.stub.fido.uaf.crypto.Base64url;
import org.ebayopensource.stub.fido.uaf.crypto.FidoAttestationSigner;
import org.ebayopensource.stub.fido.uaf.crypto.FixedCertFidoAttestationSigner;
...
public class RegAssertionBuilder {
	...
	private byte[] getSignature(byte[] dataForSigning) throws Exception {
		FidoAttestationSigner attestSigner = new FixedCertFidoAttestationSigner(keyPair);
	...
	private byte[] getKeyId() throws IOException {
		...
		//HARD-CODE KEYID FOR TESTING
		keyId="WldKaGVTMTBaWE4wTFd0bGVTMUtSRXBvU2tSRmQwcEZiSGxYUjNodFlsVldNVkpYU1hWamVUbHFWRmRWTlZWcE9ETlpNbFU5";
